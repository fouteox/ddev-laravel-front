[![tests](https://github.com/fouteox/ddev-laravel-front/actions/workflows/tests.yml/badge.svg)](https://github.com/fouteox/ddev-laravel-front/actions/workflows/tests.yml) ![project is maintained](https://img.shields.io/maintenance/yes/2025.svg)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.laravel-front.yaml](docker-compose.laravel-front.yaml) file.
...
3. Globally replace "laravel-front" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.laravel-front.yaml` with the `docker-compose.*.yaml` for your recipe.
